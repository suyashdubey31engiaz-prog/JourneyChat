  ...
  <div style={{ position:"absolute",inset:0,overflow:"hidden",borderRadius:"inherit",pointerEvents:"none" }}>
    {[
      ...
      <div key={i} style={{
        ...
        borderRadius:"50%",background:o.bg,filter:"blur(40px)",
...
const DeviceIllustration = () => (
  <svg viewBox="0 0 420 290" fill="none" xmlns="http://www.w3.org/2000/svg"
    style={{ width:"100%", maxWidth:380, filter:"drop-shadow(0 10px 36px rgba(0,245,255,0.11))" }}>
    ...
    <rect x="240" y="109" width="68" height="4" rx="2" fill="rgba(255,255,255,0.04)"/>
    ...
    <rect x="313" y="74" width="34" height="5" rx="2" fill="rgba(255,230,0,0.1)"/>
    <circle cx="322" cy="95" r="6" fill="rgba(255,230,0,0.13)" stroke="rgba(255,230,0,0.27)" strokeWidth="1"/>
    <circle cx="337" cy="95" r="6" fill="rgba(255,230,0,0.09)" stroke="rgba(255,230,0,0.2)" strokeWidth="1"/>
    <circle cx="354" cy="183" r="14" fill="rgba(255,200,160,0.82)"/>
    <rect x="342" y="198" width="24" height="36" rx="6" fill="rgba(28,38,68,0.92)"/>
    <path d="M226 104 Q204 120 158 132" stroke="rgba(0,245,255,0.17)" strokeWidth="1" strokeDasharray="4 4" fill="none"/>
    <path d="M300 124 Q272 130 242 132" stroke="rgba(255,230,0,0.13)" strokeWidth="1" strokeDasharray="4 4" fill="none"/>
    {[[44,102],[182,28],[378,56],[146,275],[392,248]].map(([x,y],i)=>(
      <circle key={i} cx={x} cy={y} r={2} fill={i%3===0?"#00F5FF":i%3===1?"#FFE600":"#4D79FF"} opacity="0.4"/>
    ))}
  </svg>
);
...
export default function Login() {
  ...
  return (
    <>
      ...
      {/* FIXED HEIGHT WRAPPER — nothing ever overflows the viewport */}
      <div style={{
        ...
        <div style={{ position:"fixed",top:0,left:0,width:420,height:420,borderRadius:"50%",
          background:"radial-gradient(circle,rgba(0,245,255,0.05) 0%,transparent 65%)",pointerEvents:"none",zIndex:0 }}/>
        <div style={{ position:"fixed",bottom:0,right:0,width:340,height:340,borderRadius:"50%",
          background:"radial-gradient(circle,rgba(77,121,255,0.06) 0%,transparent 65%)",pointerEvents:"none",zIndex:0 }}/>

        {/* ── LEFT PANEL — scrolls internally if viewport is too small ── */}
        <div className="lp-scroll" style={{
          ...
          <div style={{ display:"flex",alignItems:"center",gap:10,marginBottom:"1.2rem" }}>
            ...
            <span style={{
              fontSize:15.5,fontWeight:800,letterSpacing:"-0.3px",
          ...
          <div style={{ marginBottom:"1rem",animation:"slideUp .5s ease .08s both" }}>
            ...
            <p style={{ color:"rgba(255,255,255,0.4)",fontSize:13,margin:0 }}>Your conversations, reimagined. Welcome back.</p>
          </div>

          {/* Alerts */}
          {successMsg && (
            <div style={{ padding:"9px 13px",borderRadius:9,marginBottom:12,fontSize:12.5,
          ...
          <form onSubmit={submit} style={{ display:"flex",flexDirection:"column",gap:12 }}>
            <div style={{ animation:"slideUp .5s ease .1s both" }}>
              <StyledInput label="Username / Email" type="email" value={email}
            ...
            <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",animation:"slideUp .5s ease .2s both" }}>
              <label style={{ display:"flex",alignItems:"center",gap:7,cursor:"pointer" }}>
                <div onClick={()=>setRemember(r=>!r)} style={{
                  ...
                  background:remember?"linear-gradient(135deg,#00F5FF,#4D79FF)":"rgba(255,255,255,0.05)",
                  border:`1.5px solid ${remember?"transparent":"rgba(255,255,255,0.12)"}`,
                  display:"flex",alignItems:"center",justifyContent:"center",
                  transition:"all .2s",boxShadow:remember?"0 0 9px rgba(0,245,255,0.28)":"none",
                }}>
                ...
                <span style={{ fontSize:12.5,color:"rgba(255,255,255,0.45)",userSelect:"none" }}>Remember me</span>
              </label>
              <a href="#" style={{ fontSize:12.5,color:"#00F5FF",textDecoration:"none",fontWeight:600,opacity:.8 }}
            ...
            <div style={{ animation:"slideUp .5s ease .25s both" }}>
              ...
              onMouseLeave={e=>{ e.currentTarget.style.transform="translateY(0)"; if(!loading) e.currentTarget.style.boxShadow="0 4px 20px rgba(0,180,220,0.35), 0 0 0 1px rgba(0,245,255,0.13)"; }}>
                {loading
                  ? <><svg style={{ animation:"spin 1s linear infinite",width:15,height:15,flexShrink:0 }} fill="none" viewBox="0 0 24 24"><circle style={{opacity:.25}} cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"/><path style={{opacity:.75}} fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z"/></svg>Signing in…</>
          ...
          {/* Social */}
          <div style={{ display:"flex",alignItems:"center",gap:11,margin:"14px 0 11px",animation:"slideUp .5s ease .3s both" }}>
            <div style={{ flex:1,height:1,background:"rgba(255,255,255,0.07)" }}/>
            <span style={{ fontSize:11,color:"rgba(255,255,255,0.3)",whiteSpace:"nowrap" }}>or sign in with</span>
            <div style={{ flex:1,height:1,background:"rgba(255,255,255,0.07)" }}/>
          </div>
          <div style={{ display:"flex",gap:9,animation:"slideUp .5s ease .34s both" }}>
          ...
          <p style={{ marginTop:14,fontSize:13,color:"rgba(255,255,255,0.35)",animation:"slideUp .5s ease .38s both" }}>
            No account?{" "}
            <Link to="/register" style={{ color:"#00F5FF",fontWeight:700,textDecoration:"none",textShadow:"0 0 8px rgba(0,245,255,0.28)" }}>
              Create one →
            </Link>
          </p>
        ...
        <div style={{
          ...
          <div style={{ position:"absolute",inset:"4%",borderRadius:26,
            background:"linear-gradient(145deg,rgba(0,245,255,0.022) 0%,rgba(77,121,255,0.038) 50%,rgba(255,230,0,0.014) 100%)",
            border:"1px solid rgba(0,245,255,0.065)" }}/>
          <FloatingOrbs/>

          {/* Badges */}
          <div style={{ position:"absolute",top:"10%",left:"7%",zIndex:10,
            ...
            <div style={{ width:6,height:6,borderRadius:"50%",background:"#00F5FF",
              animation:"pulse 2s ease-in-out infinite",boxShadow:"0 0 6px #00F5FF" }}/>
            <span style={{ color:"#00F5FF",fontSize:11.5,fontWeight:700 }}>1,248 online</span>
          </div>
          <div style={{ position:"absolute",top:"14%",right:"7%",zIndex:10,
            padding:"6px 13px",borderRadius:99,
            background:"rgba(255,230,0,0.06)",border:"1px solid rgba(255,230,0,0.16)",
            backdropFilter:"blur(12px)",display:"flex",alignItems:"center",gap:6,
            animation:"floatOrb 6s ease-in-out infinite",animationDelay:"-3s" }}>
            <span style={{ fontSize:12 }}>💬</span>
            <span style={{ color:"#FFE600",fontSize:11.5,fontWeight:700 }}>24M msgs today</span>
          </div>

          {/* SVG */}
          <div style={{ position:"relative",zIndex:10,width:"80%",maxWidth:380 }}>
            <DeviceIllustration/>
          </div>

          {/* Caption */}
          <div style={{ position:"relative",zIndex:10,textAlign:"center",marginTop:"0.9rem" }}>
            <h2 style={{ fontSize:18,fontWeight:800,color:"#F0F4FF",margin:"0 0 5px",letterSpacing:"-0.2px" }}>
          ...
          <div style={{ display:"flex",gap:7,flexWrap:"wrap",justifyContent:"center",marginTop:"0.85rem",position:"relative",zIndex:10 }}>
            {[["💬","Private Chat"],["🌍","Global Channel"],["📹","Video Calls"],["🎨","Whiteboard"]].map(([icon,label])=>(
              <div key={label} style={{
                ...
                color:"rgba(255,255,255,0.43)",fontSize:11.5,
              }}>{icon} {label}</div>
            ))}
          </div>
        </div>
